class ZCL_REST_ARSERIAL definition
  public
  final
  create public .
...
private section.
  ...
  methods GET_REST
    ...
    returning
      value(EO_REST) type ref to ZIF_REST_AUTOREG .
ENDCLASS.



CLASS ZCL_REST_ARSERIAL IMPLEMENTATION.
...
CONCATENATE 'ZCL_REST_ARSERIAL_' LV_REQUEST_METHOD INTO LV_CLASS_NAME.
...
" VARIABLES
***************************************************************************
DATA: LO_REST_CLASS     TYPE REF TO ZIF_REST_AUTOREG.
